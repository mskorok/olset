...
appConfig.skins = [
    ...
    {name: "smart-style-6",
        logo: "styles/img/logo-pale-white.png",
        class: "btn btn-xs btn-block txt-color-white margin-top-5",
        ...
        .state('app.appViews.profileDemo', {
            ...
            views: {
                "content@app": {
                    ...
                    templateUrl: 'app/app-views/views/profile.html'
                }
            }
        })
...
$templateCache.put("app/layout/partials/footer.tpl.html","<div class=\"page-footer\">\r\n    <div class=\"row\">\r\n        <div class=\"col-xs-12 col-sm-6\">\r\n            <span class=\"txt-color-white\">OLSET Backoffice :: © 2017</span>\r\n        </div>\r\n\r\n        <!--<div class=\"col-xs-6 col-sm-6 text-right hidden-xs\">-->\r\n            <!--<div class=\"txt-color-white inline-block\">-->\r\n                <!--<i class=\"txt-color-blueLight hidden-mobile\">Last account activity <i class=\"fa fa-clock-o\"></i>-->\r\n                    <!--<strong>52 mins ago &nbsp;</strong> </i>-->\r\n\r\n                <!--<div class=\"btn-group dropup\">-->\r\n                    <!--<button class=\"btn btn-xs dropdown-toggle bg-color-blue txt-color-white\" data-toggle=\"dropdown\">-->\r\n                        <!--<i class=\"fa fa-link\"></i> <span class=\"caret\"></span>-->\r\n                    <!--</button>-->\r\n                    <!--<ul class=\"dropdown-menu pull-right text-left\">-->\r\n                        <!--<li>-->\r\n                            <!--<div class=\"padding-5\">-->\r\n                                <!--<p class=\"txt-color-darken font-sm no-margin\">Download Progress</p>-->\r\n\r\n                                <!--<div class=\"progress progress-micro no-margin\">-->\r\n                                    <!--<div class=\"progress-bar progress-bar-success\" style=\"width: 50%;\"></div>-->\r\n                                <!--</div>-->\r\n                            <!--</div>-->\r\n                        <!--</li>-->\r\n                        <!--<li class=\"divider\"></li>-->\r\n                        <!--<li>-->\r\n                            <!--<div class=\"padding-5\">-->\r\n                                <!--<p class=\"txt-color-darken font-sm no-margin\">Server Load</p>-->\r\n\r\n                                <!--<div class=\"progress progress-micro no-margin\">-->\r\n                                    <!--<div class=\"progress-bar progress-bar-success\" style=\"width: 20%;\"></div>-->\r\n                                <!--</div>-->\r\n                            <!--</div>-->\r\n                        <!--</li>-->\r\n                        <!--<li class=\"divider\"></li>-->\r\n                        <!--<li>-->\r\n                            <!--<div class=\"padding-5\">-->\r\n                                <!--<p class=\"txt-color-darken font-sm no-margin\">Memory Load <span class=\"text-danger\">*critical*</span>-->\r\n                                <!--</p>-->\r\n\r\n                                <!--<div class=\"progress progress-micro no-margin\">-->\r\n                                    <!--<div class=\"progress-bar progress-bar-danger\" style=\"width: 70%;\"></div>-->\r\n                                <!--</div>-->\r\n                            <!--</div>-->\r\n                        <!--</li>-->\r\n                        <!--<li class=\"divider\"></li>-->\r\n                        <!--<li>-->\r\n                            <!--<div class=\"padding-5\">-->\r\n                                <!--<button class=\"btn btn-block btn-default\">Support</button>-->\r\n                            <!--</div>-->\r\n                        <!--</li>-->\r\n                    <!--</ul>-->\r\n                <!--</div>-->\r\n            <!--</div>-->\r\n        <!--</div>-->\r\n    </div>\r\n</div>");
$templateCache.put("app/layout/partials/header.tpl.html","<header id=\"header\">\n    <div id=\"logo-group\">\n\n        <!-- PLACE YOUR LOGO HERE -->\n\n        <span id=\"logo\"> <img src=\"styles/img/logo-backoffice-white.png\" alt=\"OLSET\"> </span>\n        <!-- END LOGO PLACEHOLDER -->\n\n        <!-- Note: The activity badge color changes when clicked and resets the number to 0\n        Suggestion: You may want to set a flag when this happens to tick off all checked messages / notifications -->\n        <!-- <span id=\"activity\" class=\"activity-dropdown\" activities-dropdown-toggle>\n            <i class=\"fa fa-user\"></i>\n            <b class=\"badge bg-color-red\">21</b>\n        </span>\n        <div smart-include=\"app/dashboard/activities/activities.html\"></div> -->\n    </div>\n\n\n    <recent-projects></recent-projects>\n\n\n    <!-- pulled right: nav area -->\n    <div class=\"pull-right\">\n\n        <!-- collapse menu button -->\n        <div id=\"hide-menu\" class=\"btn-header pull-right\">\n        <span> <a toggle-menu title=\"Collapse Menu\"><i\n                class=\"fa fa-reorder\"></i></a> </span>\n        </div>\n        <!-- end collapse menu -->\n\n        <!-- #MOBILE -->\n        <!-- Top menu profile link : this shows only when top menu is active -->\n        <ul id=\"mobile-profile-img\" class=\"header-dropdown-list hidden-xs padding-5\">\n            <li class=\"\">\n                <a href=\"#\" class=\"dropdown-toggle no-margin userdropdown\" data-toggle=\"dropdown\">\n                    <img src=\"styles/img/avatars/sunny.png\" alt=\"John Doe\" class=\"online\"/>\n                </a>\n                <ul class=\"dropdown-menu pull-right\">\n                    <li>\n                        <a href-void class=\"padding-10 padding-top-0 padding-bottom-0\"><i\n                                class=\"fa fa-cog\"></i> Setting</a>\n                    </li>\n                    <li class=\"divider\"></li>\n                    <li>\n                        <a ui-sref=\"app.appViews.profileDemo\" class=\"padding-10 padding-top-0 padding-bottom-0\"> <i\n                                class=\"fa fa-user\"></i>\n                            <u>P</u>rofile</a>\n                    </li>\n                    <li class=\"divider\"></li>\n                    <li>\n                        <a href-void class=\"padding-10 padding-top-0 padding-bottom-0\"\n                           data-action=\"toggleShortcut\"><i class=\"fa fa-arrow-down\"></i> <u>S</u>hortcut</a>\n                    </li>\n                    <li class=\"divider\"></li>\n                    <li>\n                        <a href-void class=\"padding-10 padding-top-0 padding-bottom-0\"\n                           data-action=\"launchFullscreen\"><i class=\"fa fa-arrows-alt\"></i> Full <u>S</u>creen</a>\n                    </li>\n                    <li class=\"divider\"></li>\n                    <li>\n                        <a href=\"#/login\" class=\"padding-10 padding-top-5 padding-bottom-5\" data-action=\"userLogout\"><i\n                                class=\"fa fa-sign-out fa-lg\"></i> <strong><u>L</u>ogout</strong></a>\n                    </li>\n                </ul>\n            </li>\n        </ul>\n\n        <!-- logout button -->\n        <div id=\"logout\" class=\"btn-header transparent pull-right\">\n        <span> <a title=\"Sign Out\" ng-click=\"userLogout()\"\n                  data-logout-msg=\"You can improve your security further after logging out by closing this opened browser\"><i\n                class=\"fa fa-sign-out\"></i></a> </span>\n        </div>\n        <!-- end logout button -->\n\n        <!-- fullscreen button -->\n        <div id=\"fullscreen\" class=\"btn-header transparent pull-right\">\n        <span> <a full-screen title=\"Full Screen\"><i\n                class=\"fa fa-arrows-alt\"></i></a> </span>\n        </div>\n        <!-- end fullscreen button -->\n\n        <div id=\"help\" class=\"btn-header transparent pull-right\">\n        <span> <a href-void\n                  data-popover-placement=\"bottom\"\n                  data-popover-title=\"Info\"\n                  data-uib-popover=\"{{helpForPage}}\"\n                  id=\"info_popover\"\n                  title=\"Help for this page\"><i\n                class=\"fa fa-info\"></i></a> </span>\n        </div>\n\n        <!-- fullscreen button -->\n        <div id=\"back\" class=\"btn-header transparent pull-right\">\n        <span> <a back-step title=\"Back\"><i\n                class=\"fa fa-undo app-pointer\"></i></a> </span>\n        </div>\n\n        <!-- multiple lang dropdown : find all flags in the flags page -->\n        <language-selector></language-selector>\n        <!-- end multiple lang -->\n\n    </div>\n    <!-- end pulled right: nav area -->\n\n</header>");
$templateCache.put("app/layout/partials/help.tpl.html","<div>Test help window</div>");
$templateCache.put("app/layout/partials/navigation.tpl.html","<aside id=\"left-panel\">\n\n    <!-- User info -->\n    <div login-info></div>\n    <!-- end user info -->\n\n    <nav>\n        <ul data-smart-menu>\n            <li>\n                <a href=\"#\" title=\"Dashboard\"><i class=\"fa fa-lg fa-fw fa-home\"></i> <span\n                        class=\"menu-item-parent\">{{getWord(\'Dashboard\')}}</span></a>\n            </li>\n            <li data-menu-collapse>\n                <a><i class=\"fa fa-lg fa-fw fa-question\"></i> <span\n                        class=\"menu-item-parent app-pointer\">Administration</span></a>\n                <ul ng-if=\"isManager || isAdmin\">\n                    <li data-ui-sref-active=\"active\">\n                        <a data-ui-sref=\"app.users.manager\"><i class=\"fa fa-lg fa-fw fa-user\"></i> Users</a>\n                    </li>\n                    <li data-ui-sref-active=\"active\">\n                        <a data-ui-sref=\"app.departments.manager\"><i class=\"fa fa-lg fa-fw fa-question\"></i> <span\n                                class=\"menu-item-parent\">Departments</span></a>\n\n                    </li>\n\n                    <li data-ui-sref-active=\"active\">\n                        <a data-ui-sref=\"app.organization.manage\">\n                            <i class=\"fa fa-lg fa-fw fa-question\"></i>Organization\n                        </a>\n                    </li>\n\n                    <li ng-if=\"isManager || isAdmin\">\n                        <a data-ui-sref=\"app.groups.manager\"><i class=\"fa fa-lg fa-fw fa-square-o\"></i> <span\n                                class=\"menu-item-parent\">Groups</span></a>\n                    </li>\n                </ul>\n            </li>\n            <li ng-if=\"isManager || isAdmin || isUser\">\n                <a data-ui-sref=\"app.olset.index\"><i class=\"fa fa-lg fa-fw fa-sitemap\"></i> <span\n                        class=\"menu-item-parent\">OLSET Process</span></a>\n\n            </li>\n\n            <li>\n                <a data-ui-sref=\"app.olset.oms\"><i class=\"fa fa-lg fa-fw fa-tasks\"></i> <span\n                        class=\"menu-item-parent\">OMS BETA</span></a>\n            </li>\n            <li>\n                <a data-ui-sref=\"app.olset.csa\" class=\"app-tooltip\" data-toggle=\"tooltip\" data-placement=\"top\"\n                   title=\"Cambridge Strategy Audits!\"><i class=\"fa fa-lg fa-fw fa-book\"></i> <span\n                        class=\"menu-item-parent\">CSA BETA</span></a>\n            </li>\n\n            <li>\n                <a data-ui-sref=\"app.help.subjects\"><i class=\"fa fa-lg fa-fw fa-info\"></i> <span\n                        class=\"menu-item-parent\">Help</span></a>\n            </li>\n        </ul>\n    </nav>\n\n    <span class=\"minifyme\" data-action=\"minifyMenu\" minify-menu>\n    <i class=\"fa fa-arrow-circle-left hit\"></i>\n  </span>\n\n</aside>");
...
angular.module('app.auth').controller('LoginCtrl', function ($scope, $http, $window, $state, User, MainConf) {

    /*$scope.userLogin = function (

        $http.post(
        'http://144.76.5.203/olsetapp/users/authenticate',
          [{"key":"Authorization","value":"Basic ZGVtbzp0ZXN0MTIz","description":""}]);
    ...
    $scope.userLogin = function () {
        var sendCredentials = $scope.credentials.username + ":" + $scope.credentials.password;
        var theCredentials = Base64.encode(sendCredentials);
        ...
        $http({
            ...
            console.log(
                response,
                "Sorry, we couldn't sing you in. Please retry and be sure that you put the right credentials this time!"
            );
        });
    }
});
        ...
        link: function (scope, element, attrs) {
            attrs.$observe('involved', function (value) {
                if (value) {
                    ...
                    console.log('iu - finalJSON' , finalJson);
                    var doughnutOptions = {
                        //Boolean - Whether we should show a stroke on each segment
                        segmentShowStroke: true,
                        //String - The colour of each segment stroke
...
angular.module('app.departments').directive('departmentItemEdit', function () {
    return {

        restrict: 'EA',
        scope: true,
        template: '<div class="modal fade" id="myModal1E" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"' +
        ' aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header">' +
        '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>' +
        '<h4 class="modal-title" id="myModalLabel">Create Group</h4></div><div class="modal-body">' +
        '<div class="row"><div class="col-md-12"><div class="form-group"><input type="text" class="form-control"' +
        ' ng-model="groupData.title" name="title" placeholder="Group Title" required /></div><div class="form-group">' +
        '<label style="color: #888;font-size: 12px;">Color</label><input type="color" class="form-control" ' +
        'ng-model="groupData.color" name="color" required /></div></div></div></div><div class="modal-footer">' +
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" ' +
        'ng-click="addItem()" data-dismiss="modal" class="btn btn-primary">Add Group</button></div></div></div></div>',
        transclude: true,
        link: function (scope, element, attributes) {
            scope.groupData = {
                'title': '',
            ...
            scope.addItem = function () {//todo
                console.log('department edit item: ', scope.$$nextSibling);
                //scope.$apply(function(){
...
angular.module('app.groups').directive('groupItemEdit', function () {
    return {
        ...
        ' data-ng-model="groupData.title" name="title" placeholder="Group Title" required /></div>' +
        '<div class="form-group"><label style="color: #888;font-size: 12px;">Color</label>' +
        ...
        ' class="btn btn-primary">Edit Group</button></div></div></div></div>',
        transclude: true,
        link: function (scope, element, attributes) {
            scope.groupId = scope;
            console.log("groupItemEdit attr:  ", attributes);
            ...
            scope.addItem = function () {//todo strange function
                ...
                console.log('groupItemEdit addItem: ', scope.$$nextSibling.group.color);
                //scope.$apply(function(){
                //scope.addFunc({title: scope.groupData.title, color: scope.groupData.color});
                //});
            };
    ...
    function ($scope, $http, $window, $stateParams, $state, $timeout, MainConf, ngDialog) {
        ...
        var generalProcessInfos = function () {
            $http({
                ...
                $scope.olsetProcessData = response.data.process;
                console.log('Olset generalProcessInfos data error', response);
                alert('Olset generalProcessInfos data error');
            });
            ...
            $http({
                ...
                console.log('Olset generalProcessInfos data  success', $scope.permissionsData.department);
        ...
        $scope.toggleUserSelection = function toggleSelection(userId) {
            ...
            console.log("permissionsData.persons:" + $scope.permissionsData.persons);
        };
        ...
        var departmentsData1 = function () {
            $http({
                ...
                console.log('Olset departmentsData1 data error', response);
                alert('Olset departmentsData1 data error');
                return false;
            });
        };
        departmentsData1();
        ...
        var usersData1 = function () {
            $http({
                ...
                console.log('Olset usersData1 data error', response);
                alert('Olset usersData1 data error');
                return false;
            });
        };
        usersData1();
        ...
        $scope.departmentsUserData = function (departmentsId) {
            ...
            $http({
                ...
                console.log('Olset departmentsUserData data error', response);
                alert('Olset departmentsUserData data error');
                return false;
            });
        };
        ...
        $scope.wizard1CompleteCallback = function () {
            ...
            $http({
                ...
                $http({
                    ...
                    console.log('Olset wizard1CompleteCallback data error', response);
                    alert('Olset wizard1CompleteCallback data error');
                });
    ...
    function ($scope, $http, $window, $stateParams, $document, $state, $timeout, MainConf, ngDialog) {
        ...
        $scope.editSurveyQuestion = function () {
            $http({
                ...
                console.log('Olset editSurveyQuestion data error', response);
                alert('Olset editSurveyQuestion data error');
            });
        };
        ...
        $scope.changeProcessStatus = function (theProcessId) {
            ...
            $http({
                ...
                $scope.olsetIndexData = response.data.process;
                console.log('changeProcessStatus success', $scope.olsetIndexData);
            }, function errorCallback(response) {
                console.log('Olset changeProcessStatus data error', response);
                alert('Olset changeProcessStatus data error');
                $scope.olsetIndexData = response.data.process;
            });
        };
            ...
            $.SmartMessageBox({
                ...
                if (ButtonPressed === "Yes") {
                    ...
                    $http({
                        ...
                        console.log("deleteOlsetIndexItem success: ", response);
                        //var code = response.data.data.code;
                        // var title = (code == 1)? "SUCCESS" : "ERROR";
                        // var color = (code == 1)? "#739E73" : "#d81e1e";
                        // var icon = (code == 1)? "fa fa-check" : "fa fa-exclamation-triangle";
                        ...
                        console.log('Olset deleteOlsetIndexItem data error', response);
                        alert('Olset deleteOlsetIndexItem data error');
                    });
...
angular.module('app.survdefs').directive('survdefItemAdd', function () {
    return {
        ...
        '</div><div class="modal-body"><div class="row"><div class="col-md-12">' +
        '<div class="form-group"><input type="text" class="form-control" data-ng-model="departmentData.title"' +
        ' name="title" placeholder="Department Title" required /></div><div class="form-group">' +
        '<input type="text" class="form-control" data-ng-model="departmentData.description"' +
        ' name="Description" placeholder="Description" required /></div></div></div></div>' +
        '<div class="modal-footer"><button type="button" class="btn btn-default"' +
        ' data-dismiss="modal">Cancel</button><button type="button" data-ng-click="addItem()"' +
        ' data-dismiss="modal" class="btn btn-primary">Add Department</button></div></div></div></div>',
        transclude: true,
        link: function (scope, element, attributes) {
...
angular.module('app.users').controller(
    'usrManagerCtrl',
    function ($scope, $http, $window, $state, DTOptionsBuilder, DTColumnBuilder, MainConf, ngDialog) {
        ...
        var datas = function () {
            ...
            $http({
                ...
                console.log('Users users data success', response);
                $scope.usersData = response.data.users;
            }, function errorCallback(response) {
                console.warn('Users users data error', response);
                alert('Users users data error');
            });
            ...
            $.SmartMessageBox({
                ...
                if (ButtonPressed === "Yes") {
                    ...
                    $http({
                        ...
                        console.log('Users deactivateOtherUser data success', response);
                        var code = response.data.data.code;
                        var title = code === 1 ? "SUCCESS" : "ERROR";
                        var color = code === 1 ? "#739E73" : "#d81e1e";
                        var icon = code === 1 ? "fa fa-check" : "fa fa-exclamation-triangle";
                        ...
                        console.warn('Users deactivateOtherUser data error', response);
                        alert('Users deactivateOtherUser data error');
                    });
...
angular.module('SmartAdmin.Layout').directive(
    'smartLayout', function ($rootScope, $timeout, $interval, $q, SmartCss, APP_CONFIG
    ) {
...
angular.module('app.auth').directive('facebookSignin', function ($rootScope, ezfb) {
    return {
        replace: true,
        restrict: 'E',
        template: '<a class="btn btn-block btn-social btn-facebook"><i class="fa fa-facebook">' +
...
angular.module('app.auth').directive('googleSignin', function ($rootScope, GooglePlus) {
    return {
        restrict: 'E',
        template: '<a class="g-signin btn btn-block btn-social btn-google-plus"><i class="fa fa-google-plus">' +
        ...
        link: function (scope, element, attributes) {
            ...
            if (attributes.bindFilters) {
                element.parent().find("div.toolbar").html(
                    '<div class="text-right"><img src="styles/img/logo.png" alt="SmartAdmin" style="width: 111px;' +
                    ' margin-top: 3px; margin-right: 10px;"></div>'
                );
...
angular.module('app.users').directive('usertablesColumnFilter', function () {
    return {
        restrict: 'A',
        link: function (scope, element, attributes) {
            /* // DOM Position key index //
