...
angular.module('app.auth').controller('LoginCtrl', function ($scope, $http, $window, $state, User, MainConf) {
	...
	/*$scope.userLogin = function (
		...
		$http.post('http://144.76.5.203/olsetapp/users/authenticate',  [{"key":"Authorization","value":"Basic ZGVtbzp0ZXN0MTIz","description":""}]);
	...
	$scope.userLogin = function() { 
		...
		var sendCreds = $scope.credentials.username + ":" + $scope.credentials.password;
		var theCreds = Base64.encode(sendCreds);
		...
		$http({
		    ...
		    headers: {'Authorization': 'Basic '+theCreds}
			...
			console.log("Sorry, we couldn't sing you in. Please retry and be sure that you put the right credentials this time!");

		});
		

			
		/*if (thelogin.statusText == "Unauthorized") {
			console.log("Wrong Credentials, Please try again");
		}
		
		if (thelogin.$$state.value.data.token) {
			$window.location.href = '#';
		}*/
		//console.log(thelogin);
	}
	//console.log('ccCCcc');ZGVtbzp0ZXN0MTIz
	/*var iprec = "http://freegeoip.net/json/";
	$http.get(iprec).then(function(response) {
		//console.log(response);
		$scope.yourip = response.data.ip;
	});*/
})
...
angular.module('app.departments').controller('departmentsCtrl', function ($scope, $http, $window, $stateParams, $state, $timeout, MainConf, ngDialog) {
	...
	$scope.addDepartmentItem = function (title, description) {
		console.log('call');
		$http({
	...
	$scope.deleteDepartment = function(grpid) {
		...
		$.SmartMessageBox({
            ...
            content: "The "+$scope.departmentsData.title+" department will be removed, are you sure about that ?",
            buttons: '[No][Yes]'
    ...
    return {
        ...
        link: function (scope, element, attributes) {
	       //var groupd = scope.$$nextSibling.group;
		    ...
		    scope.addItem  = function () {
			    //console.log('Patithika');
				 console.log('edidir23: ', scope.$$nextSibling);
				//scope.$apply(function(){
...
angular.module('app.groups').directive('groupItemAdd', function () {
    return {
        ...
        template: '<div class="modal fade" id="myModalC" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">Create Group</h4></div><div class="modal-body"><div class="row"><div class="col-md-12"><div class="form-group"><input type="text" class="form-control" ng-model="groupData.title" name="title" placeholder="Group Title" required /></div><div class="form-group"><label style="color: #888;font-size: 12px;">Color</label><input type="color" class="form-control" ng-model="groupData.color" name="color" required /></div></div></div></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" ng-click="addItem()" data-dismiss="modal" class="btn btn-primary">Add Group</button></div></div></div></div>',
        transclude: true,
        link: function (scope, element, attributes) {
...
angular.module('app.help').controller('helpSubjectCtrl', function ($scope, $window, $state, User, Auth, $location, $rootScope, $http, MainConf, $sce) {
...
var helpData = function () {
    ...
    $http({
        ...
        if (response.data.data.code === 1) {
            ...
            console.log('DDSS000', $scope.helpForPageSubject);
...
angular.module('app.layout').controller('HeaderCtrl', function ($scope, $window, $state, User, Auth, $location, $rootScope, $http, MainConf, $element) {
    ...
    $rootScope.$on('$locationChangeStart', function (event) {
        ...
        //$scope.slug.slug.split('/')[0]
            ...
            $http({
                ...
                console.log('Current route name11: ' + $scope.slug.slug);
                if (response.data.data.code === 1) {
...
"use strict";
angular.module('app.olset').controller('olsetCreateCtrl', function ($scope, $http, $window, $stateParams, $state, $timeout, MainConf, ngDialog) {
...
angular.module('app.olset').controller('olsetEvaluationCtrl', function ($scope, $http, $window, $stateParams, $document, $state, $timeout, MainConf, ngDialog) {
...
//addOrganizationItem
angular.module('app.organization').controller('organizationCtrl', function ($scope, $http, $window, $stateParams, $state, $timeout, MainConf, ngDialog) {
...
angular.module('app.survdefs').controller('survdefsCtrl', function ($scope, $http, $window, $stateParams, $state, $timeout, MainConf) {
...
angular.module('app.surveys').directive('surveyItemAdd', function () {
    return {
        ...
        template: '<div class="modal fade" id="myModalC" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">Create a new survey</h4></div><div class="modal-body"><div class="row"><div class="col-md-12"><div class="form-group"><input type="text" class="form-control" ng-model="surveyData.title" name="title" placeholder="Survey Title" required /></div><div class="form-group"><input type="text" class="form-control" ng-model="surveyData.description" name="Description" placeholder="Description" required /></div></div></div></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" ng-click="addItem()" data-dismiss="modal" class="btn btn-primary">Add Survey</button></div></div></div></div>',
        transclude: true,
        link: function (scope, element, attributes) {
		    ...
		    scope.addItem  = function () {
				...
				//scope.$apply(function(){
					scope.addFunc({title: scope.surveyData.title, description: scope.surveyData.description, isEditable: scope.surveyData.isEditable, isOlset: scope.surveyData.isOlset});
				//});
		    };
	       ...
	       //var groupd = scope.$$nextSibling.group;
		    ...
		    scope.addItem  = function () {
			    //console.log('Patithika');
				 console.log('edidir23: ', scope.$$nextSibling);
				//scope.$apply(function(){
				scope.addFunc({title: scope.groupData.title, description: scope.groupData.description, isEditable: scope.groupData.isEditable, isOlset: scope.groupData.isOlset});
				//});
		    };
...
angular.module('app.sysmap').controller('sysMapCtrl', function ($scope, $http, $window, $state, $timeout, MainConf, $stateParams) {
	...
	$scope.exportit = function(sysmid,name){
		...
		$http({
		    ...
		    for (var j=0;j<tdatasr.length;j++)
		    {
		        ...
		        //console.log('mySheetItems:',mySheetItems);
			...
			for (var i=0; mySpreadSheet.length > i; i++) 
			{
			  ...
			  var res = alasql('SELECT * INTO XLSX("'+name+'.xlsx",?) FROM ?',[sheetsCountsAndNames,mySpreadSheet]);
