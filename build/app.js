...
angular.module('app.maps').factory('SmartMapStyle', function ($q, $http, APP_CONFIG) {
    ...
    var styles = {
        ...
        'nightvision-highlight': {
            ...
            url: APP_CONFIG.apiRootUrl + '/maps/nightvision-highlight.json'
        },
...
angular.module('app.ui').directive('smartJquiDynamicTabs', function ($timeout) {
    ...
    function addDomEvents(element) {
        ...
        function addTab() {
            var label = tabTitle.val() || "Tab " + tabCounter, id = "tabs-" + tabCounter,
...
// function
    ...
    (function (undefined) {
        ...
        var commandsList = [], recognition, callbacks = {
            ...
            optionalParam = /\s*\((.*?)\)\s*/g, optionalRegex = /(\(\?:[^)]+\))\?/g, namedParam = /(\(\?)?:\w+/g,
            splatParam = /\*\w+/g, escapeRegExp = /[\-{}\[\]+?.,\\\^$|#]/g, commandToRegExp = function (command) {
